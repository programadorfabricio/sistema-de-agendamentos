...
const COVER_PHOTO_BLUR_DATA_URL =
  "data:image/jpeg;base64,";
  ...
  return (
    <div className="cover">
      <div className="cover-photo">
        <Image
          src="https://picsum.photos/seed/barbershop-interior/800/500"
          alt=""
          fill
